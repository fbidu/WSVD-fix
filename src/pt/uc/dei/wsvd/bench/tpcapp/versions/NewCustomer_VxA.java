...
import pt.uc.dei.wsvd.bench.tpcapp.input.NewCustomerInput;
import pt.uc.dei.wsvd.bench.tpcapp.output.NewCustomerOutput;
...
public class NewCustomer_VxA {
    ...
    public NewCustomerOutput process(NewCustomerInput input) throws Exception {
...
//            }
    ...
    private synchronized long insertCostumer(Connection conn, NewCustomerInput input, long addr_id_temp) throws SQLException {
        ...
        int discount = randomGenerator.nextInt(100);
        String sql = "";
        Statement stmt = Database.createStatement(conn);
